...
export default function PageHeader({ title, onBack, right }) {
  ...
  return (
    <header className="relative flex h-[56px] items-center px-4 bg-tokenCard border-b border-tokenBorderSubtle">
      <button
        onClick={handleBack}
      ...
      <h1 className="pointer-events-none absolute inset-x-0 text-center text-[18px] font-semibold text-tokenText">{title}</h1>
